...
public class Translation2d {
    ...
    public Translation2d(double distance, Rotation2d angle) {
        m_x = distance * Math.cos(angle.toDouble());
        m_y = distance * Math.sin(angle.toDouble());
    }


    /**
     * Constructs a Translation2d from a Vector2d's x and y components
     *
    ...
    /** @return A Vector2d representation of this translation. */
    ...
    public Translation2d rotateBy(Rotation2d other) {
        return new Translation2d(
                m_x * Math.cos(other.toDouble()) - m_y * Math.sin(other.toDouble()),
                m_x * Math.sin(other.toDouble()) + m_y * Math.cos(other.toDouble())
        );
    }
    ...
    public String toString() {
        return "Translation2d(X: " + m_x + ", Y: " + m_y + ")";
    }
