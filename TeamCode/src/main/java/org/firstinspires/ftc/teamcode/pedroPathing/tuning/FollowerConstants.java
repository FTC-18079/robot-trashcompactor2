...
public class FollowerConstants {
    ...
    private static double xMovement = 59.19400823146686;
    private static double yMovement = 44.86672535328446;
    ...
    public static double forwardZeroPowerAcceleration = -116.779648914;
