...
public class FollowerConstants {
    ...
    private static double xMovement = 54.9574255;
    private static double yMovement = 39.46383902219012;
    ...
    public static double mass = 10.795;
    ...
    public static double forwardZeroPowerAcceleration = -84.68314951161104;

    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    public static double lateralZeroPowerAcceleration = -121.31600404922332;
